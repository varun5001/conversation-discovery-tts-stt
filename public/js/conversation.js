...
var ConversationPanel = (function() {
	...
	function buildMessageDomElements(newPayload, isUser) {
		...
		textArray.forEach(function(currentText) {
			if (currentText) {
				var feedbackLength = document.getElementsByClassName('feedback').length;
				var messageJson = {
					// <div class='segments'>
					'tagName': 'div',
					'classNames': ['segments'],
							...
							'children': [{
								...
								'children': [{
									...
									'attributes': [{
										...
										'name': 'src',
										'value': '/img/thumb_up.png'
									},{
										'name': 'onclick',
										'value': 'feedBack(document.getElementsByClassName("feedback")[' + feedbackLength + '])'
									}]
								}, {
									'tagName': 'img',
									'attributes': [{
